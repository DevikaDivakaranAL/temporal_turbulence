...
class ComputeRefractiveIndexStructureParameter(object):
    ...
    def __init__(self, windSpeedObject, c2n_model, height, hv_ground_cst=1.7e-14):
    ...
    def compute_HAP_nighttime(self, h):
        # nighttime
        # LARRY B. STOTTS, AND LARRY C. ANDREWS,Improving the Hufnagel-Andrews-Phillips refractive index structure parameter model using turbulent intensity
        # eq 2
        # Computes c2n with Hufnagel-Andrew-Philips model
        RI = 1 * (
    ...
    def compute_c2n_fct(self):
        if self.c2n_model == 'day':
            ...
            # print(self.height,              self.c2n_value)
